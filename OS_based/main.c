...
void main()
{
	...
	printf(" 1-FOR UPDATING DAILY BILLS\n");
	printf(" 2-FOR UPDATING BANK AMOUNT AND WIDROW AMOUNT \n");
	printf(" 3-FOR UPDATING CREDIT CARD WITHDROWAL\n");
	printf(" 4-FOR DISPLAY LAST DAY TRANSACTION\n");
	printf(" 5-FOR DISPLAY LAST MONTH TRANSACTION \n");
	printf("   _________________________________________________\n");
	scanf("%d", &choice_get);
	switch (choice_get)
	{
...
//		break;
	...
	case 5:
		...
		printf(" PLEASE ENTER THE MONTH IN MM FORMAT\n");
